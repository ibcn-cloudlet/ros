...
void subscribe_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 1)
        {
            ...
            catch(std::exception& ex)
            {
                ...
                msg += " when reading input argument 1 (topicName)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 1 (topicName)";
        ...
        if(numArgs >= 2)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 2 (topicType)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 2 (topicType)";
                throw exception(ss.str());
            }
        }
        ...
        if(numArgs >= 3)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 3 (topicCallback)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 3 (topicCallback)";
                throw exception(ss.str());
            }
        }
        ...
        if(numArgs >= 4)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 4 (queueSize)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 4 (queueSize)";
                throw exception(ss.str());
            }
        }
    ...
    try
    {
        ...
        {
            std::string msg = ex.what();
            msg += " when writing output argument 1 (subscriberHandle)";
            throw exception(msg);
        }
        catch(std::string& s)
        {
        ...
        {
            std::stringstream ss;
            ss << "error #" << n << " (when writing output argument 1 (subscriberHandle))";
            throw exception(ss.str());
        }
    }
    catch(std::exception& e)
...
void shutdownSubscriber_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 1)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 1 (subscriberHandle)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 1 (subscriberHandle)";
                throw exception(ss.str());
            }
        }
...
void advertise_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 3)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 3 (queueSize)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 3 (queueSize)";
                throw exception(ss.str());
            }
        }
        ...
        if(numArgs >= 4)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 4 (latch)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 4 (latch)";
                throw exception(ss.str());
            }
        }
    ...
    try
    {
        ...
        {
            std::string msg = ex.what();
            msg += " when writing output argument 1 (publisherHandle)";
            throw exception(msg);
        }
        catch(std::string& s)
        {
        ...
        {
            std::stringstream ss;
            ss << "error #" << n << " (when writing output argument 1 (publisherHandle))";
            throw exception(ss.str());
        }
    }
    catch(std::exception& e)
...
void shutdownPublisher_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 1)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 1 (publisherHandle)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 1 (publisherHandle)";
                throw exception(ss.str());
            }
        }
...
void serviceClient_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 1)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 1 (serviceName)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 1 (serviceName)";
                throw exception(ss.str());
            }
        }
        ...
        if(numArgs >= 2)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 2 (serviceType)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 2 (serviceType)";
                throw exception(ss.str());
            }
        }
    ...
    try
    {
        ...
        {
            std::string msg = ex.what();
            msg += " when writing output argument 1 (serviceClientHandle)";
            throw exception(msg);
        }
        catch(std::string& s)
        {
        ...
        {
            std::stringstream ss;
            ss << "error #" << n << " (when writing output argument 1 (serviceClientHandle))";
            throw exception(ss.str());
        }
    }
    catch(std::exception& e)
...
void shutdownServiceClient_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 1)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 1 (serviceClientHandle)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 1 (serviceClientHandle)";
                throw exception(ss.str());
            }
        }
...
void advertiseService_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 3)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 3 (serviceCallback)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 3 (serviceCallback)";
                throw exception(ss.str());
            }
        }
    ...
    try
    {
        ...
        {
            std::string msg = ex.what();
            msg += " when writing output argument 1 (serviceServerHandle)";
            throw exception(msg);
        }
        catch(std::string& s)
        {
        ...
        {
            std::stringstream ss;
            ss << "error #" << n << " (when writing output argument 1 (serviceServerHandle))";
            throw exception(ss.str());
        }
    }
    catch(std::exception& e)
...
void shutdownServiceServer_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 1)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 1 (serviceServerHandle)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 1 (serviceServerHandle)";
                throw exception(ss.str());
            }
        }
...
void imageTransportSubscribe_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 2)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 2 (topicCallback)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 2 (topicCallback)";
                throw exception(ss.str());
            }
        }
...
void imageTransportAdvertise_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 2)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 2 (queueSize)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 2 (queueSize)";
                throw exception(ss.str());
            }
        }
...
void imageTransportPublish_callback(SScriptCallBack *p)
{
    ...
    try
    {
        ...
        if(numArgs >= 2)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 2 (data)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 2 (data)";
                throw exception(ss.str());
            }
        }
        ...
        if(numArgs >= 3)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 3 (width)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 3 (width)";
                throw exception(ss.str());
            }
        }
        ...
        if(numArgs >= 4)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 4 (height)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 4 (height)";
                throw exception(ss.str());
            }
        }
        ...
        if(numArgs >= 5)
        {
            ...
            {
                std::string msg = ex.what();
                msg += " when reading input argument 5 (frame_id)";
                throw exception(msg);
            }
            catch(std::string& s)
            {
            ...
            {
                std::stringstream ss;
                ss << "error #" << n << " when reading input argument 5 (frame_id)";
                throw exception(ss.str());
            }
        }
